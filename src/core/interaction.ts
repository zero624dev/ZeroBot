...
type TScripts = { [key in Locale]?: IScripts };
...
export function hasCustomId(interaction: ButtonInteraction | AnySelectMenuInteraction | ModalSubmitInteraction, scripts: { [key in Locale]?: IScripts }) {
...
export function interactionHandler(interaction: Interaction<"cached">, scripts: { [key in Locale]?: IScripts }) {
    return new Promise<void>(async (_, reject) => {
        try {
